...
import 'package:flutter_callkit_incoming_example/phone_call_state.dart';
            ...
            Column(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>PhoneCallState()));
                  },
                ),
                const Divider(),
              ],
